...
import com.android.calendar.datetimepicker.common.ConfirmDialog;
...
public abstract class WheelPicker extends ConfirmDialog<View> {
    ...
    protected int TEXT_SIZE = 25;//sp
    protected int TEXT_COLOR_NORMAL = 0XFFBBBBBB;
    protected int TEXT_COLOR_FOCUS = 0XFF0288CE;
    protected int ITEM_OFF_SET = 2;
